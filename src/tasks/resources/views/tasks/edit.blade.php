...
<form action="{{ route('tasks.update', $task) }}" method="post">
    ...
    <div class="form-group">
        ...
        <input type="date" name="expiration_date" id="expiration_date"
            ...
            value="{{ old('expiration_date') ? old('expiration_date') : $task->expiration_date }}">
    ...
    <div class="form-group">
        ...
        <input type="date" name="completion_date" id="completion_date"
            ...
            value="{{ old('completion_date') ? old('completion_date') : $task->completion_date }}">
    ...
    <div class="form-group">
        ...
        <textarea name="description" id="descriptin" rows="5"
            class="form-control @error('description') is-invalid @enderror ">{{ old('description') ? old('description') : $task->description }}</textarea>
        @error('description')
